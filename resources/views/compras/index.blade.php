          ...
          <tr class="text-secondary">
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-sm btn-secondary" href="{{ route('compras.edit', ['id' => $element->id]) }}" title="Editar compra"> <i class="fas fa-edit"></i></a>
                 {{-- Eliminar registro --}}
                {!! Form::open([
                  'method'=>'DELETE',
                  'url' => ['compras', $element->id],
                  'style' => 'display:inline',
                  'onsubmit' => 'return confirm("Realmente desea eliminar este Registro");'
                  ]) !!}
                  {{ Form::button('<i class="fa fa-trash"></i>', ['title'=>'Eliminar', 'type' => 'submit', 'class' => 'btn btn-danger btn-sm'] )  }}
                  {!! Form::close() !!}
              </td>
