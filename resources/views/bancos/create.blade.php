  ...
  <div class="row justify-content-center">
    <div class="col-md-8" id="banco-nuevo">
      ...
      <div class="form-group {{ $errors->has('codigo') ? 'has-error' : '' }}">
        ...
        {{-- {!! Form::select('codigo', $codigos, null, ['class'=>'form-control col-md-6', 'placeholder'=> 'Seleccione', 'name' => 'codigo']) !!} --}}
      ...
      <div class="form-group {{ $errors->has('cuenta') ? 'has-error' : '' }}">
        ...
        {!! Form::text('cuenta', null, ['class'=> 'form-control col-md-6']) !!}
      ...
      <div class="form-group {{ $errors->has('tipo') ? 'has-error' : '' }}">
        ...
        {!! Form::select('tipo', ['ahorro'=>'Ahorro', 'corriente'=>'Corriente'], null, ['class'=>'form-control col-md-6', 'placeholder' => 'Seleccione']) !!}
      ...
      <div class="form-group {{ $errors->has('saldo') ? 'has-error' : '' }}">
        ...
        {!! Form::number('saldo', 0.00, ['class'=>'form-control col-md-6','placeholder'=> '0.00','step'=>'any']) !!}
