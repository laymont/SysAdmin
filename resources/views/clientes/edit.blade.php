    ...
    <div class="col-md-8">
      ...
      <div class="form-group {{ $errors->has('rif') ? 'has-error' : ''}}">
        ...
        <div class="form-inline">
          {!! Form::select('rifl', ['J'=>'J','V'=>'V','E'=>'E','G'=>'G'], substr($cliente->rif,0,1), ['class'=>'form-control col-md-1']) !!}
          {!! Form::number('rifn', substr($cliente->rif,2,8).substr($cliente->rif,-1), ['class'=>'form-control col-md-4','placeholder'=>'0000000000']) !!}
        </div>
      ...
      <div class="form-group {{ $errors->has('nombre') ? 'has-error' : ''}}">
        ...
        {!! Form::text('nombre', $cliente->nombre, ['class'=>'form-control col-md-5', 'placeholder'=>'Denominación Comercial']) !!}
      ...
      <div class="form-group {{ $errors->has('retiene') ? 'has-error' : ''}}">
        <div class="form-inline">
          ...
          {!! Form::select('retiene', [0=>'No',1=>'100%',2=>'75%'], $cliente->retiene, ['class'=>'form-control col-md-2']) !!}
        </div>
      ...
      <div class="form-group {{ $errors->has('isrl') ? 'has-error' : ''}}">
        <div class="form-inline">
          ...
          {!! Form::select('isrl', [0=>'No',1=>'Si'], $cliente->isrl, ['class'=>'form-control col-md-2']) !!}
        </div>
      ...
      <div class="form-group {{ $errors->has('direccion') ? 'has-error' : ''}}">
        ...
        {!! Form::textarea('direccion', $cliente->direccion, ['class'=>'form-control col-md-5', 'size' => '30x3', 'placeholder'=>'Lorem ipsum dolor sit amet.']) !!}
      ...
      <div class="form-group {{ $errors->has('telefono') ? 'has-error' : ''}}">
        ...
        {!! Form::textarea('telefono', $cliente->telefono, ['class'=>'form-control col-md-5', 'size' => '30x3', 'placeholder'=>'0000 000 0000']) !!}
      ...
      <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
        ...
        {!! Form::email('email', $cliente->email, ['class'=>'form-control col-md-5', 'placeholder'=>'buzon@midominio.com']) !!}
      ...
      <div class="form-group {{ $errors->has('credito') ? 'has-error' : ''}}">
        ...
        <div class="form-inline">
          {!! Form::select('credito', ['No'=>'No','Si'=>'Si'], $cliente->credito, ['class'=>'form-control col-md-1']) !!}
          {!! Form::number('dias', $cliente->dias, ['class'=>'form-control col-md-2']) !!}
        </div>
