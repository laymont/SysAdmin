...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      {!! Form::model($servidor, ['method'=>'PATCH','route'=>['servidores.update', $servidor->id]]) !!}
      {{-- Tipo --}}
      <div class="form-group {{ $errors->has('tipo') ? 'has-error' : '' }}">
        {!! Form::label('tipo', 'Tipo', ['class'=>'control-label']) !!}
        {!! Form::select('tipo', [1=>'Vendedor'], $servidor->tipo, ['class'=>'form-control col-md-5','placeholder'=>'Seleccione']) !!}
      ...
      <div class="form-group {{ $errors->has('identificacion') ? 'has-error' : '' }}">
        ...
        {!! Form::text('identificacion', $servidor->identificacion, ['class'=>'form-control col-md-5','placeholder'=>'Identificacion Unica']) !!}
      ...
      <div class="form-group {{ $errors->has('nombre') ? 'has-error' : '' }}">
        ...
        {!! Form::text('nombre', $servidor->nombre, ['class'=>'form-control col-md-5','placeholder'=>'Nombre descriptivo']) !!}
      ...
      <div class="form-group {{ $errors->has('porcentaje') ? 'has-error' : '' }}">
        ...
        {!! Form::number('porcentaje', $servidor->porcentaje, ['class'=>'form-control col-md-5','placeholder'=>'Indique el porcentaje %','step'=>'0.01']) !!}
      ...
      <div class="form-group {{ $errors->has('monto') ? 'has-error' : '' }}">
        ...
        {!! Form::number('monto', $servidor->monto, ['class'=>'form-control col-md-5','placeholder'=>'Monto fijo','step'=>'0.01']) !!}
