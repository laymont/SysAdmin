...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-md-12">
      <table id="proveedores_lista" class="table table-bordered table-striped datatables" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $element->dias }}</td>
            <td>
              <a class="btn btn-sm btn-warning" href="{{ route('proveedores.edit', ['id' => $element->id]) }}" title="Editar"> <i class="fas fa-edit"></i></a>
            </td>
          </tr>
          @endforeach
        </tbody>
...
<script>
  ...
  $(document).ready(function(){
    oTable = $('#proveedores_lista').DataTable({
